...
import cn.byteorchid.magnetv.response.ReportData;
import cn.byteorchid.magnetv.response.ReportItem;
import cn.byteorchid.magnetv.service.MagnetRuleService;
import cn.byteorchid.magnetv.service.MagnetService;
import cn.byteorchid.magnetv.service.PermissionService;
import cn.byteorchid.magnetv.service.ReportService;
...
public class MagnetApiController {
    ...
    public BaseResponse<MagnetPageData> search(HttpServletRequest request, @RequestParam(required = false) String source, @RequestParam(required = false) String keyword,
        ...
        data.setRule(rule);
        data.setAria2Rpc(config.aria2Rpc);
        data.setAria2RpcToken(config.aria2RpcToken);
